/*
 * @Author: 谢瑶
 * @Date: 2022-04-01 23:25:43
 * @LastEditors: huangl
 * @LastEditTime: 2022-04-02 00:03:32
 * @Description: file content
 * @FilePath: \dlopen\framework\include\Timers.h
 */
...
static CONSTEXPR inline nsecs_t milliseconds_to_nanoseconds(nsecs_t 
secs) { 
return secs * 1000000; 
}

static CONSTEXPR inline nsecs_t microseconds_to_nanoseconds(nsecs_t
secs) {
return secs * 1000;
}
...
static CONSTEXPR inline nsecs_t nanoseconds_to_milliseconds(nsecs_t
secs) {
return secs / 1000000;
}
static CONSTEXPR inline nsecs_t nanoseconds_to_microseconds(nsecs_t
secs) {
return secs / 1000;
}
...
SYSTEM_TIME_BOOTTIME = 4 // same as SYSTEM_TIME_MONOTONIC, but
};
