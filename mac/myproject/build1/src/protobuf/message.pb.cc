...
const uint32_t TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::xy::Person_PhoneNumber, _impl_.number_),
  PROTOBUF_FIELD_OFFSET(::xy::Person_PhoneNumber, _impl_.type_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::xy::Person, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::xy::Person, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::xy::Person, _impl_.email_),
  PROTOBUF_FIELD_OFFSET(::xy::Person, _impl_.phones_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::xy::Person_PhoneNumber)},
  { 8, -1, -1, sizeof(::xy::Person)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::xy::_Person_PhoneNumber_default_instance_._instance,
  &::xy::_Person_default_instance_._instance,
};
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "xy.Person.PhoneNumber.number"));
        } else
          goto handle_unusual;
        continue;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "xy.Person.name"));
        } else
          goto handle_unusual;
        continue;
      // int32 id = 2;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "xy.Person.email"));
        } else
          goto handle_unusual;
        continue;
...
template<> PROTOBUF_NOINLINE ::xy::Person_PhoneNumber*
Arena::CreateMaybeMessage< ::xy::Person_PhoneNumber >(Arena* arena) {
  return Arena::CreateMessageInternal< ::xy::Person_PhoneNumber >(arena);
}
template<> PROTOBUF_NOINLINE ::xy::Person*
Arena::CreateMaybeMessage< ::xy::Person >(Arena* arena) {
