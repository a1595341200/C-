...
.LFE1729:
	...
	.align	3
.LC3:
	.string	"insert into user (id,name,age,mobile) values (2,'xxx',20,'15011186301')"
	.align	3
.LC4:
	.string	"testsqlite3.db"
	.align	3
.LC5:
	.string	"open sqlite3 fail."
	.align	3
.LC6:
	.string	"open sqlite3 ok."
	.align	3
.LC7:
	.string	"insert fail"
	.align	3
.LC8:
	.string	"insert data ok."
	.align	3
.LC9:
...
.L15:
	...
	mov	x4, x1
	mov	x3, x0
	adrp	x0, _ZL8callbackPviPPcS1_
	add	x2, x0, :lo12:_ZL8callbackPviPPcS1_
	mov	x1, x5
	mov	x0, x19
	bl	sqlite3_exec
	ldr	x0, [sp, 56]
...
.LLSDA2078:
	.byte	0xff
	.byte	0x9b
	.uleb128 .LLSDATT2078-.LLSDATTD2078
.LLSDATTD2078:
	.byte	0x1
