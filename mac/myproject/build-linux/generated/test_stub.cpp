...
<node>
    <interface name="Yao.Xie.Test">
        <method name="getName">
            <arg type="s" name="Param1" direction="in"></arg>
            <arg type="ay" name="name" direction="out"></arg>
        </method>
    </interface>
</node>
)XML_DELIMITER";

#include "/home/parallels/clion/build-linux/generated/test_stub.h"
...
Yao::Xie::TestStub::TestStub():
    m_interfaceName("Yao.Xie.Test")
{
}
...
guint Yao::Xie::TestStub::register_object(
    ...
    const Glib::ustring &object_path)
{
    ...
    try {
        registration_id = connection->register_object(object_path,
            introspection_data->lookup_interface("Yao.Xie.Test"),
            *interface_vtable);
    } catch(const Glib::Error &ex) {
...
void Yao::Xie::TestStub::unregister_object()
{
...
void Yao::Xie::TestStub::on_method_call(
    const Glib::RefPtr<Gio::DBus::Connection> &/* connection */,
    ...
    const Glib::RefPtr<Gio::DBus::MethodInvocation> &invocation)
{
    ...
    if (method_name.compare("getName") == 0) {
...
void Yao::Xie::TestStub::on_interface_get_property(
...
bool Yao::Xie::TestStub::on_interface_set_property(
    const Glib::RefPtr<Gio::DBus::Connection> &/* connection */,
    const Glib::ustring &/* sender */,
    const Glib::ustring &/* object_path */,
    const Glib::ustring &/* interface_name */,
...
bool Yao::Xie::TestStub::emitSignal(
