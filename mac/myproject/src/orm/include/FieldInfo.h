...
{
public:
    FieldInfo(const std::string &strFieldName, ValueType valueType, int offset) : m_strFieldName(strFieldName),
...
#define T_IF_INT(Field, T)                                                                                                                   \
    typename std::enable_if<                                                                                                                 \
        (std::is_enum_v<std::decay_t<Field>> || std::is_integral_v<std::decay_t<Field>>)&&!std::is_same_v<std::decay_t<Field>, long long> && \
