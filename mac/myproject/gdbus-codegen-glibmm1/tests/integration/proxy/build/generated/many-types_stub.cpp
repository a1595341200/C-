...
#include "/Users/xieyao/Desktop/git/C-/mac/myproject/gdbus-codegen-glibmm/tests/integration/proxy/build/generated/many-types_stub.h"
    ...
    m_interfaceName("org.gdbus.codegen.glibmm.Test")
{
    ...
    TestSelectiveSignal_signal.connect(sigc::bind<0>(sigc::mem_fun(this, &TestStub::TestSelectiveSignal_emitter),
            std::vector<Glib::ustring>({""})) );
    TestSelectiveSignal_selectiveSignal.connect(sigc::mem_fun(this, &TestStub::TestSelectiveSignal_emitter));
}
...
void org::gdbus::codegen::glibmm::TestStub::TestSelectiveSignal_emitter(
    const std::vector<Glib::ustring> &destination_bus_names,bool Param1)
{
    std::vector<Glib::VariantBase> paramsList;
