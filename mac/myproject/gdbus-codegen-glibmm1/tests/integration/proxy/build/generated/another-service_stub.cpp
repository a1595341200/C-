...
<node>
  <interface name="org.gdbus.codegen.glibmm.TestTwo">
  </interface>
</node>
)XML_DELIMITER";

#include "/Users/xieyao/Desktop/git/C-/mac/myproject/gdbus-codegen-glibmm/tests/integration/proxy/build/generated/another-service_stub.h"
...
org::gdbus::codegen::glibmm::TestTwoStub::TestTwoStub():
    m_interfaceName("org.gdbus.codegen.glibmm.TestTwo")
{
}
...
guint org::gdbus::codegen::glibmm::TestTwoStub::register_object(
    ...
    const Glib::ustring &object_path)
{
    ...
    Gio::DBus::InterfaceVTable *interface_vtable =
        new Gio::DBus::InterfaceVTable(
            sigc::mem_fun(this, &TestTwoStub::on_method_call),
            sigc::mem_fun(this, &TestTwoStub::on_interface_get_property),
            sigc::mem_fun(this, &TestTwoStub::on_interface_set_property));

    guint registration_id;
    try {
        registration_id = connection->register_object(object_path,
            introspection_data->lookup_interface("org.gdbus.codegen.glibmm.TestTwo"),
            *interface_vtable);
    } catch(const Glib::Error &ex) {
...
void org::gdbus::codegen::glibmm::TestTwoStub::unregister_object()
{
...
void org::gdbus::codegen::glibmm::TestTwoStub::on_method_call(
    const Glib::RefPtr<Gio::DBus::Connection> &/* connection */,
...
void org::gdbus::codegen::glibmm::TestTwoStub::on_interface_get_property(
...
bool org::gdbus::codegen::glibmm::TestTwoStub::on_interface_set_property(
    const Glib::RefPtr<Gio::DBus::Connection> &/* connection */,
    const Glib::ustring &/* sender */,
    const Glib::ustring &/* object_path */,
    const Glib::ustring &/* interface_name */,
...
bool org::gdbus::codegen::glibmm::TestTwoStub::emitSignal(
