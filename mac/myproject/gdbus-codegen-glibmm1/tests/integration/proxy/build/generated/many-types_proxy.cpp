...
#include "/Users/xieyao/Desktop/git/C-/mac/myproject/gdbus-codegen-glibmm/tests/integration/proxy/build/generated/many-types_proxy.h"
    ...
    const Glib::VariantContainerBase& parameters)
{
    ...
    if (signal_name == "TestSelectiveSignal") {
        if (parameters.get_n_children() != 1) return;
        Glib::Variant<bool> base_Param1;
        parameters.get_child(base_Param1, 0);
        bool p_Param1;
        ...
        TestSelectiveSignal_signal.emit((p_Param1));
    }
}
