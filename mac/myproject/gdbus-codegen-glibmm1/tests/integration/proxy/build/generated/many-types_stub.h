...
#include <glibmm.h>
#include <giomm.h>
#include "/Users/xieyao/Desktop/git/C-/mac/myproject/gdbus-codegen-glibmm/tests/integration/proxy/build/generated/many-types_common.h"
...
protected:
    ...
    void TestSelectiveSignal_emitter(const std::vector<Glib::ustring> &destination_bus_names, bool);
    sigc::signal<void, bool> TestSelectiveSignal_signal;
    sigc::signal<void, const std::vector<Glib::ustring>&, bool> TestSelectiveSignal_selectiveSignal;
