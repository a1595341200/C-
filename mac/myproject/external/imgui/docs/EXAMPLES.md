...
You can find Window binaries for some of those example applications at:
...
You may prefer to use the GLFW Or SDL backends, which will also support Window and Linux.)
...
GLUT (e.g., FreeGLUT on Linux/Window, GLUT framework on OSX) + OpenGL2 example. <BR>
...
SDL2 + DirectX11 example, Window only. <BR>
