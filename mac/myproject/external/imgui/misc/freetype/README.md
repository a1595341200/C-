...
1. Get latest FreeType binaries or build yourself (under Window you may use vcpkg with `vcpkg install freetype --triplet=x64-windows`, `vcpkg integrate install`).
