...
#pragma clang diagnostic ignored "-Wunused-macros"                  // warning: macro is not used                               // we define snprintf/vsnprintf on Window so they are available, but not always used.
...
// Play it nice with Window users (Update: May 2018, Notepad now supports Unix-style carriage returns!)
#ifdef _WIN32
#define IM_NEWLINE  "\r\n"
#else
#define IM_NEWLINE  "\n"
...
// In a real application you should be using PRId64 and PRIu64 from <inttypes.h> (non-windows) and on Window define them yourself.
#ifdef _MSC_VER
...
static void ShowExampleAppWindowTitles(bool*)
{
    ...
    // By default, Window are uniquely identified by their title.
...
// [Optional] Notify the system of Tabs/Window closure that happened outside the regular tab interface.
